...
exports.ModalContainer = exports.modalStateConfig = exports.addModalStyle = exports.addWindow = undefined;
...
var addWindow = exports.addWindow = function addWindow(name, component) {
  windowMapper[name] = component;
};

var modalStyleMapper = {};
var addModalStyle = exports.addModalStyle = function addModalStyle(name, _ref5) {
...
var modalStateConfig = exports.modalStateConfig = {
  path: "modal",
...
var ModalContainer = exports.ModalContainer = (0, _dongbao.connect)({
  path: __dirname
